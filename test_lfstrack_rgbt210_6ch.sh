#!/bin/bash
# LFSTrack - RGBT210 test (6ch config)
#
# Usage:
#   bash test_lfstrack_rgbt210_6ch.sh                  # automatically pick the latest checkpoint
#   bash test_lfstrack_rgbt210_6ch.sh 30               # specify epoch
#   bash test_lfstrack_rgbt210_6ch.sh /path/to/ckpt    # specify checkpoint path
#   bash test_lfstrack_rgbt210_6ch.sh latest 2         # second argument: number of workers
#
# Data path: env var RGBT_DATA_ROOT (default /root/RGBTData, contains RGBT210/)
...
echo "============================================"
echo "  LFSTrack RGBT210 (6ch) Evaluation"
echo "  Config:     ${CONFIG}"
