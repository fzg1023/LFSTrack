#!/bin/bash
# LFSTrack - LasHeR 6ch test
#
# Usage:
#   bash test_lfstrack_lasher_6ch.sh                # automatically pick the latest checkpoint
#   bash test_lfstrack_lasher_6ch.sh 50             # specify epoch
#   bash test_lfstrack_lasher_6ch.sh /path/to/ckpt  # specify checkpoint path
...
echo "============================================"
echo "  LFSTrack LasHeR 6ch Evaluation"
echo "  Config:     ${CONFIG}"
