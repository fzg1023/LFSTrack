#!/bin/bash
# LFSTrack - RGBT234 test (6ch config)
#
# Usage:
#   bash test_lfstrack_rgbt234_6ch.sh                  # automatically pick the latest checkpoint
#   bash test_lfstrack_rgbt234_6ch.sh 30               # specify epoch
#   bash test_lfstrack_rgbt234_6ch.sh /path/to/ckpt    # specify checkpoint path
#   bash test_lfstrack_rgbt234_6ch.sh latest 2         # second argument: number of workers
#
...
echo "============================================"
echo "  LFSTrack RGBT234 (6ch) Evaluation"
echo "  Config:     ${CONFIG}"
