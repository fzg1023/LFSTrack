...
class EnvironmentSettings:
    def __init__(self):
        ...
        self.depthtrack_dir = ''
        self.lasher_dir = os.environ.get('LASHER_TRAIN_HOME', '/home/fzg/data/lasher/trainingset')
        self.lasher_test_dir = os.environ.get('LASHER_HOME', '/home/fzg/data/lasher/testingset')
        self.visevent_dir = ''
