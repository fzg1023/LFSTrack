...
def local_env_settings():
    ...
    settings.lasher_path = os.environ.get('LASHER_HOME', '/root/RGBTData/LasHeR/test')
    settings.vtuav_path = os.environ.get('VTUAV_HOME', '/root/RGBTData/VTUAV')
    settings.rgbt234_path = os.environ.get('RGBT234_HOME', '/root/RGBTData/RGBT234')
    settings.otb_path = ''
    settings.nfs_path = ''
    settings.uav_path = ''
    settings.tpl_path = ''
