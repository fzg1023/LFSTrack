...
|---|---|---|
| `LASHER_TRAIN_HOME` | LasHeR training set root | `/home/fzg/data/lasher/trainingset` |
| `LASHER_HOME` | LasHeR test set root | `/home/fzg/data/lasher/testingset` |
| `VTUAV_HOME` | VTUAV root (contains train / test_ST / test_LT) | `/home/fzg/data/vtuav` |
...
```bash
# Example
export LASHER_TRAIN_HOME=/path/to/lasher/trainingset
export LASHER_HOME=/path/to/lasher/testingset
export VTUAV_HOME=/path/to/VTUAV
export RGBT_DATA_ROOT=/path/to/RGBTData   # root containing GTOT/RGBT210/RGBT234/VTUAV
```
...
|---|---|---|---|---|---|---|
| LasHeR 4ch/6ch | 384 / 192 | 16 | 1e-4 (bb x0.1) | 50 | 0.2 | 5e-4 |
...
- **Multiple GPUs**: training scripts default to `CUDA_VISIBLE_DEVICES=0`, which
