#!/bin/bash
# LFSTrack - RGBT210 test (4ch config)
#
# Usage:
#   bash test_lfstrack_rgbt210_4ch.sh                  # automatically pick the latest checkpoint
#   bash test_lfstrack_rgbt210_4ch.sh 30               # specify epoch
#   bash test_lfstrack_rgbt210_4ch.sh /path/to/ckpt    # specify checkpoint path
#   bash test_lfstrack_rgbt210_4ch.sh latest 2         # second argument: number of workers
#
...
echo "============================================"
echo "  LFSTrack RGBT210 (4ch) Evaluation"
echo "  Config:     ${CONFIG}"
